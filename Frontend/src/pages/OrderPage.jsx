...
import { Book, BookOpen, Calendar, Heart, Minus, Plus, Search, ShoppingCart, Star, Trash2 } from "lucide-react";
            ...
            <div className="sticky top-6 backdrop-blur-xl bg-white/70 rounded-3xl p-6 shadow-xl border border-white/20">
              ...
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  <div className="mb-4">
                    <label className="block text-sm font-semibold text-slate-800 mb-2">Select Return Date</label>
                    <div className="relative">
                      <DatePicker
                        selected={returnDate}
